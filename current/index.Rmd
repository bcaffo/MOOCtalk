...
#temp$cumEnroll <- cumsum(temp$enrollment)
#temp$cumSOA <- cumsum(temp$soa) * 10
#m1 <- mPlot(x = "date", y = c("cumEnroll", "cumSOA"), type = "Line", data = temp)
#m1$set(pointSize = 10, lineWidth = 5)
m1 <- mPlot(enrollment ~ type = "Line", data = temp))
```
