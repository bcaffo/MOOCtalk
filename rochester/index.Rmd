...
enrollment = c(20671, 17481, 15636, 13517, 
                8274,  5279,     0,     0),
class = c(rep("MBBC1", 4), rep("MBBC2", 4)),
offering = as.character(c(2 : 4, 1, 1 : 4))
)
myData <- myData[order(myData$offering),]

n1 <- nPlot(enrollment ~ class, group = "offering", data = myData, type = "multiBarChart")
n1$save('../fig/savechart.html', cdn = TRUE)
cat('<iframe src="../fig/savechart.html" width=100%, height=600></iframe>')
```
