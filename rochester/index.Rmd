...
class = c(rep("MBBC1", 4), rep("MBBC2", 4), rep("CDA", 4)),
offering = as.character(c(c(2 : 4, 1), 1 : 4, c(3, 4, 1, 2)))
)
myData <- myData[order(myData$offering),]

n1 <- nPlot(enrollment ~ offering, group = "class", data = myData, type = "multiBarChart")
n1$save('../fig/classPlot1.html', cdn = TRUE)
cat('<iframe src="../fig/classPlot1.html" width=100%, height=600></iframe>')
```
---
